...
dependencies {
    ...
    constraints {
        ...
        api("kg.apc:jmeter-plugins-cmn-jmeter:0.6")
        ...
        api("oro:oro:2.0.8")
        api("software.amazon.awssdk:auth:2.21.1")
        api("software.amazon.awssdk:regions:2.21.1")
        api("software.amazon.awssdk:s3:2.21.1")
        api("software.amazon.awssdk:sdk-core:2.21.1")
