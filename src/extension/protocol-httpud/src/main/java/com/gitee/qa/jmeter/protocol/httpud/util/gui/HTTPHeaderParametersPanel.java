 ...
 */
public class HTTPHeaderParametersPanel extends ArgumentsPanel {
    ...
    public static boolean testFunctors(){
        HTTPHeaderParametersPanel instance = new HTTPHeaderParametersPanel();
...
//    }
    ...
    public HTTPHeaderParametersPanel() {
        super("HTTP信息头");
        init();
    }
     ...
     * 
     * @return a collection of {@link Arguments} entries
     */
...
//    protected boolean isMetaDataNormal(Argument arg) {
