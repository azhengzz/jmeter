...
public class PerforAutoUltimateThreadGroup
        extends AbstractPerforAutoSimpleThreadGroup
        implements Serializable, TestStateListener {

    private static final Logger log = LoggerFactory.getLogger(PerforAutoUltimateThreadGroup.class);
    ...
    public PerforAutoUltimateThreadGroup() {
        super();
    }
    ...
    private CollectionProperty getLoadFromExternalProperty() {
        ...
        if (loadProp != null && loadProp.length() > 0) {
            ...
            PowerTableModel dataModel = new PowerTableModel(PerforAutoUltimateThreadGroupGui.columnIdentifiers, PerforAutoUltimateThreadGroupGui.columnClasses);
            ...
            return JMeterPluginsUtils.tableModelRowsToCollectionProperty(dataModel, PerforAutoUltimateThreadGroup.DATA_PROPERTY);
        }
        return null;
    }
