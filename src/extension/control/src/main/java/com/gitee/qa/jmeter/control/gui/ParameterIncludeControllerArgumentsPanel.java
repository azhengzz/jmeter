...
public class ParameterIncludeControllerArgumentsPanel extends ArgumentsPanel {
    ...
    public ParameterIncludeControllerArgumentsPanel() {
        super();
    }

    public ParameterIncludeControllerArgumentsPanel(String label) {
        super(label);
    }
     ...
     * */
    public ParameterIncludeControllerArgumentsPanel(String label, boolean descriptionColumnEditable, boolean notNullColumnEditable, boolean requiredColumnEditable) {
        super(label);
        JTable t = getTable();
...
//            editor.getComponent().setEnabled(false);
    ...
    public static boolean testFunctors() {
        ParameterIncludeControllerArgumentsPanel instance = new ParameterIncludeControllerArgumentsPanel("");
