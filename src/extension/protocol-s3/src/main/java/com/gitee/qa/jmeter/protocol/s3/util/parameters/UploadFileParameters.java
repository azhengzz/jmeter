...
public final class UploadFileParameters {

    // 私有构造函数，避免该类被实例化
    private UploadFileParameters(){}
    ...
    public static final String KEY_DESC = "对象键（S3中的文件路径，注意：不要以'/'开头）";
    public static final boolean KEY_NOTNULL = true;
    public static final boolean KEY_REQUIRED = true;

    public static final String FILE_PATH = "<file-path>";
    public static final String FILE_PATH_DESC = "本地文件路径";
    public static final boolean FILE_PATH_NOTNULL = true;
    public static final boolean FILE_PATH_REQUIRED = true;
